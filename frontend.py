...
#lessons learned
#use poper formating when importing data from database, save time and use less gimicky code
# use less DOITALL functions, split tasks for visibility
# use easier to understand names 
# put more comments explaining the funcions
# mby try OOP
